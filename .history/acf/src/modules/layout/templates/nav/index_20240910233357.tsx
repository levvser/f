    ...
    <>
      <header className="w-full bg-white">
        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between h-16">
          ...
          <div className="flex items-center pl-0 lg:pl-4">
            <LocalizedClientLink
              href="/"
          ...
          <div className="hidden md:flex flex-1 justify-between ml-12 pr-4 lg:pr-6">
        ...
        >
          ...
          <div
            className="flex space-x-4 overflow-x-auto scrollbar scrollbar-thumb-gray-500 scrollbar-track-gray-200"
            ref={thirdRowRef}
